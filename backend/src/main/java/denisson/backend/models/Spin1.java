...
public class Spin1 {
    ...
    public Spin1(Long id, double temperatura, double m_a, double m_b, double mag_staggered, double mag_total) {
        this.id = id;
    ...
    public Spin1(double temperatura, double m_a, double m_b, double mag_staggered, double mag_total) {
        this.temperatura = temperatura;
        this.m_a = m_a;
        this.m_b = m_b;
        this.mag_staggered = mag_staggered;
